...
export class NativeHelperBackend implements vscode.Disposable {
    private readonly output = vscode.window.createOutputChannel("Ridiculous Coding Audio");
    private process?: ChildProcessWithoutNullStreams;
    private startResult: NativeHelperStartResult = { ok: false, reason: "Helper not started." };
